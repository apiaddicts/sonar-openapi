...
public class ServerTest extends BaseNodeTest<AsyncApiGrammar> {
  ...
  public void can_parse_server_with_variable() {
    JsonNode node = parseResource(AsyncApiGrammar.SERVER, "/models/v4/server.yaml");
    ...
    assertEquals("mqtt", node, "/protocol");
    ...
    assertElements(node, "/variables/port/enum").containsExactly("1883", "8883");
